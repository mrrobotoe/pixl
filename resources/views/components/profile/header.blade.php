    ...
    <nav class="h-full overflow-x-auto [scrollbar-width:none]">
        <ul class="flex min-w-max justify-end gap-8 text-sm">
            <li>
                ...
                class="{{ request()->routeIs('profiles.show') ? '' : "text-pixl-light/60 hover:text-pixl-light/80" }}"
                >Posts</a>
            </li>
            <li>
                <a
                    href="{{ route('profiles.replies', $profile) }}"
                    class="{{ request()->routeIs('profiles.replies') ? '' : "text-pixl-light/60 hover:text-pixl-light/80" }}"
                >Replies</a
                >
            </li>
            <li>
