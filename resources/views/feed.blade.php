...
<main class="-mx-4 flex grow flex-col gap-4 overflow-y-auto px-4 py-4">
    ...
    <ol class="mt-4">
        ...
        <li class="flex items-start gap-4 not-first:pt-2.5">
            <a href="/profile" class="shrink-0">
                <img
                    src="/images/michael-workshop.png"
                    alt=""
                    class="size-10 object-cover"
                />
            </a>
                  ...
                  ></span>
                    ...
                    <div class="mt-6 flex items-center justify-between gap-4">
                        <div class="flex items-center gap-8">
                            ...
                            <!-- Comment button -->
                            <div class="flex items-center gap-1">
                                <button aria-label="comment" class="hover:text-pixl/80">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        class="h-[17px]"
                        ...
                        <div class="flex items-center gap-3">
                            <!-- Save button -->
                            <div class="flex items-center gap-1">
                                <button aria-label="save" class="hover:text-pixl/80">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        class="h-[17px]"
                                ...
                                <span class="text-pixl-light/40 text-sm">12</span>
                            </div>

                            <!-- Share button -->
                            <div class="flex items-center gap-1">
                                <button aria-label="share" class="hover:text-pixl/80">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        class="h-[17px]"
                    ...
                    >
                        ...
                        <form class="grow" action="">
                            ...
                            <div class="flex justify-between">
                                ...
                                <button
                                    class="bg-pixl/10 text-pixl hover:bg-pixl/15 active:bg-pixl/20 border border-transparent px-4 py-1.5 text-sm transition"
                                    type="submit"
                                >
                                    Post
                                </button>
                    ...
                    <li class="group/reply relative flex items-start gap-4 pt-4">
                        ...
                        <div class="border-pixl-light/10 grow border-b pt-1.5 pb-5">
                            ...
                            <div class="flex items-center justify-between gap-4">
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <p class="text-pixl-light/60 text-xs">1 hour ago</p>
                                    <p class="text-pixl-light/60 text-xs">
                                        <a
                                            href="/profile"
                                            class="hover:text-pixl-light/60 hover:underline"
                      ...
                      ></span>
                            ...
                            <div class="mt-4 flex flex-col gap-3 text-sm">
                                <p>lmao I'm buying this i don't even car.</p>
                            </div>
...
>
    <input
        type="text"
        placeholder="# Search an idea or pixl"
        class="border-pixl-light/20 w-full text-sm"
    />
    ...
    <!-- Follow idea streams -->
    <div class="border-pixl-light/20 mt-4 border p-4">
        ...
        <ol class="mt-4 flex flex-col gap-2.5">
            <li class="flex items-center justify-between gap-2">
                ...
                <button
                    class="bg-pixl-dark/50 border-pixl/50 text-pixl hover:bg-pixl-dark/55 hover:border-pixl/55 active:bg-pixl-dark/75 active:border-pixl/75 border px-1.5 py-0.5 text-2xl leading-none transition"
                >
                    +
                </button>
            </li>
